...
<body onload="check();updateCurrentPage('start');">
    ...
    <nav>
        <ul>
            <li><a href="#login" onclick="updateCurrentPage('login')">login</a></li>
            <li><a href="#register" onclick="updateCurrentPage('register')">register</a></li>
            <li><a href="#profile" onclick="updateCurrentPage('profile')">profile</a></li>
            <li><a href="#logout" onclick="updateCurrentPage('logout')">logout</a></li>
        </ul>
    </nav>
    <h1></h1>
    <h3>Challenges</h3>
